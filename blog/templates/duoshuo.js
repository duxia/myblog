...
function(e, t, s) {
    ...
    function n(e) {
        j.theme = e, "none" != e && o.injectStylesheet(j.STATIC_URL + "/styles/embed" + (e ? "." + e + ".css?" + R[e] : "." + short_name) + ".css")
    }
    var o = {},
    ...
    if (o.extend = function(e, t) {
        ...
        j.require = function() {
            ...
            return "undefined" != typeof jQuery && jQuery.fn.jquery >= "1.5" && (s["embed.compat"] = !0, j.jQuery = e.jQuery), function(e, a) {
        ...
        for (var I = 0, M = ["EmbedThread", "RecentComments", "RecentVisitors", "TopUsers", "TopThreads", "LoginWidget", "ThreadCount"]; I < M.length; I++) j[M[I]] = function(e) {
            return function(t, s) {
        ...
        var A = j.API = {
            ajax: function(e, t, i, r, n) {
                ...
                function l(e, t, s) {
                    ...
                    o ? r && r(a) : "parseerror" === l ? S.error("解析错误: " + s) : (S.error("出错啦(" + a.code + "): " + a.errorMessage), n && n(a), a.errorTrace && S.error(a.errorTrace)), d(m)
                }
                ...
                send: function(s) {
                    ...
                    if (a.messages.push(p.stringify(s)), !a.webSocket) {
                        ...
                        n.onopen = function() {
                            ...
                            switch (t.type) {
                            case "post":
                                for (var a, r = 0; r < j.pagelets.length; r++) a = j.pagelets[r], a.threadId == t.thread_id && a.onMessage(t);
                                break;
                            case "notification":
                                _.push(t), i()
                            }
        ...
        j.DOMAIN = "duoshuo.com", j.STATIC_URL = b + "//static.duoshuo.com", j.REMOTE = b + "//duoshuo.com", j.version = "15.1.30";
        var R = {
            "default": "5c5fd1ac",
            dark: "155718bb",
            bluebox: "a36fcf1a",
            ...
            W = {
                ...
                save: function(e, t) {
                    if (m) try {
                        m.removeItem(e), m[e] = p.stringify(t), m.removeItem(e + ":timestamp"), m[e + ":timestamp"] = Math.floor((new Date - y) / 1e3)
                    } catch (s) {}
                }
            },
        ...
        var Q = j.Event = J.extend({
            ...
            G = $.extend({
                toJSON: function() {
                    ...
                    return e.theAuthor = ut[this.data.author_id] && ut[this.data.author_id].data || this.data.author, e.parents = this.data.parents || [], e
                }
            }),
            Y = $.extend({
                toJSON: function() {
        ...
        var X = {
            ...
            loginUrl: function(e, t) {
                return t || (t = {}), c.sso && c.sso.login && (t.sso = 1, t.redirect_uri = c.sso.login), a() + "/login/" + e + "/" + T(t)
            },
            bindUrl: function(e) {
        ...
        tt.commentList = function(e) {
            ...
            var e = '<h2>社交帐号登录</h2><ul class="ds-service-list">' + tt.serviceList(K) + '</ul><ul class="ds-service-list ds-additional-services">' + tt.additionalServices() + "</ul>";
            return e
            ...
            return t += '</div><div class="ds-actions">', e.service ? t += st({
                "service[]": e.service
            }) : (t += '<label><input type="checkbox" name="service[]" value="weibo"', ot.data.social_uid.weibo && (t += ' checked="checked"'), t += ' /><span class="ds-service-icon ds-weibo"></span>新浪微博</label><label><input type="checkbox" name="service[]" value="qqt"', ot.data.social_uid.qq && (t += ' checked="checked"'), t += ' /><span class="ds-service-icon ds-qqt"></span>腾讯微博</label>'), t += '<button type="submit">' + D.repost + "</button></div></form>"
            ...
            if (t += '<li class="ds-post" data-post-id="' + s.post_id + '"><div class="ds-post-self" data-post-id="' + s.post_id + '" data-thread-id="' + s.thread_id + '" data-root-id="' + s.root_id + '" data-source="' + s.source + '"><div class="ds-avatar"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ">" + tt.avatar(r), j.sourceName[s.source] && (t += tt.serviceIcon(s.source)), t += '</div><div class="ds-comment-body"><div class="ds-comment-header">', r.url ? (t += '<a class="ds-user-name ds-highlight" data-qqt-account="' + (r.qqt_account || "") + '" href="' + u(r.url) + '" ', r.user_id && (t += " onclick=\"this.href='" + a() + "/user-url/?user_id=" + r.user_id + "';\""), t += ' rel="nofollow" target="_blank"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ">" + u(r.name) + "</a>") : (t += '<span class="ds-user-name"', r.user_id && (t += ' data-user-id="' + r.user_id + '"'), t += ' data-qqt-account="' + (r.qqt_account || "") + '">' + u(r.name) + "</span>"), t += "</div>", 1 == i.max_depth && i.show_context && s.parents.length) {
                ...
                if (n) for (var o, d = -1, l = n.length - 1; l > d;) o = n[d += 1], 1 == d && s.parents.length > 2 && (t += '<li class="ds-ctx-entry"><a href="javascript:void(0);" class="ds-expand">还有' + (s.parents.length - 2) + "条评论</a></li>"), t += tt.ctxPost({
                    post: o,
                    index: d,
            ...
            var t = "",
                s = e.response;
            if (s) for (var a, i = -1, r = s.length - 1; r > i;) a = s[i += 1], t += '<div class="ds-avatar">' + tt.avatar(a, e.options.avatar_size) + "</div>";
            return t
            ...
            if (t += r() ? ' href="javascript:void(0);" onclick="return false"' : ' href="' + j.REMOTE + "/settings/avatar/" + T(q()) + '" target="_blank" title="设置头像"', t += ">" + tt.avatarImg(ot.data) + '</a><form method="post">' + st(e.params) + '<div class="ds-textarea-wrapper ds-rounded-top"><textarea name="message" title="Ctrl+Enter快捷提交" placeholder="' + u(D.leave_a_message) + '"></textarea><pre class="ds-hidden-text"></pre>', t += "</div>", t += '<div class="ds-post-toolbar"><div class="ds-post-options ds-gradient-bg"><span class="ds-sync">', !r() && ot.data.repostOptions) {
                t += '<input id="ds-sync-checkbox', e.inline && (t += "-inline"), t += '" type="checkbox" name="repost" ', e.checked && (t += 'checked="checked" '), t += 'value="' + e.repostArray.join(",") + '"> <label for="ds-sync-checkbox', e.inline && (t += "-inline"), t += '">' + D.share_to + "</label>";
                for (var s in ot.data.repostOptions) t += tt.serviceIcon(s, !ot.data.repostOptions[s])
            }
            return t += "</span>", t += "</div>", t += '<button class="ds-post-button" type="submit">' + u(D.post) + '</button><div class="ds-toolbar-buttons">', e.options.use_smilies && (t += '<a class="ds-toolbar-button ds-add-emote" title="插入表情"></a>'), e.options.use_images && e.options.parse_html_enabled && (t += '<a class="ds-toolbar-button ds-add-image" title="插入图片"></a>'), t += "</div></div>", t += "</form></div>"
        }, tt.serviceBindList = function(e) {
            var t = "",
                s = e;
            if (s) for (var a, i = -1, r = s.length - 1; r > i;) a = s[i += 1], t += '<li><a href="' + X.bindUrl(a) + '" rel="nofollow" class="ds-service-link ds-' + a + '">' + j.serviceNames[a], ot.data.social_uid[a] && (t += ' <span class="ds-icon ds-icon-ok"></span>'), t += "</a></li>";
            return t
        }, tt.serviceList = function(e) {
            var t = "",
                s = e;
            if (s) for (var a, i = -1, r = s.length - 1; r > i;) a = s[i += 1], t += '<li><a href="' + X.loginUrl(a) + '" rel="nofollow" class="ds-service-link ds-' + a + '">' + j.serviceNames[a] + "</a></li>";
            return t
        }, tt.shareWidget = function(e) {
            var t = '<div class="ds-share-icons"> <div class="ds-share-icons-inner"> <ul class="ds-share-icons-16"> ',
                s = e.services;
            if (s) for (var a, i = -1, r = s.length - 1; r > i;) a = s[i += 1], t += ' <li> <a class="ds-' + a + '" href="javascript:void(0);" data-service="' + a + '">' + j.sourceName[a] + "</a> </li> ";
            ...
            return e += ot.data.url ? '<a class="ds-visitor-name" href="' + u(ot.data.url) + '" target="_blank">' + u(ot.data.name) + "</a>" : '<span class="ds-visitor-name">' + u(ot.data.name) + "</span>", e += '<a class="ds-unread-comments-count" href="javascript:void(0);" title="新回复"></a></div></div>'
            ...
            var t = "",
                s = e.response;
            if (s) for (var a, i = -1, r = s.length - 1; r > i;) a = s[i += 1], t += '<div class="ds-avatar">' + tt.avatar(a, e.options.avatar_size) + "<h4>" + u(a.name) + "</h4></div>";
            return t
        }, tt.userInfo = function(e) {
            var t = '<a href="' + u(e.url) + '" class="ds-avatar" target="_blank">' + tt.avatarImg(e) + '</a><a href="' + u(e.url) + '" class="ds-user-name ds-highlight" target="_blank">' + u(e.name) + "</a>";
            for (var s in e.social_uid) t += '<a href="' + j.REMOTE + "/user-proxy/" + s + "/" + e.social_uid[s] + '/" target="_blank" class="ds-service-icon ds-' + s + '" title="' + j.sourceName[s] + '"></a>';
            return t += '<p class="ds-user-card-meta"><a href="' + j.REMOTE + "/profile/" + e.user_id + '/" target="_blank"><span class="ds-highlight">' + e.comments + "</span>条评论</a></p>", e.description && (t += '<p class="ds-user-description">' + u(e.description) + "</p>"), t
        };
        var at = j.Views = {},
            it = (j.Callbacks = {}, j.pagelets = []),
            rt = j.events = new Q,
            nt = j.site = new $,
            ot = j.visitor = new F,
            dt = j.unread = new $,
        ...
        rt.on("queryDefined", function() {
            ...
            function T() {
                var e = L("").el.find(".ds-dialog").css("width", "300px");
            ...
            function q(e, t, s, a) {
                ...
                var n = L(tt["dialog-reposts"]({
                    ...
                    o = n.el.find("form");
                return o.submit(i), o.find(".ds-actions [type=checkbox]").change(r), b(o.find("textarea")).keyup(d).keyup(l).focus(), !1
            }
            function I(e) {
                var t = {
                    "unread-comments": {
            ...
            function B(e, t) {
                function s() {
                    ...
                    return A.post("posts/vote", {
                        ...
                        vote: t ? 0 : 1
                    }), $(this).html($(this).html().replace(/\(\d+\)/, "") + (a ? "(" + a + ")" : "")), e[t ? "removeClass" : "addClass"]("ds-post-liked"), !1
                }
                function a() {
                ...
                function o() {
                    ...
                    if (a.hasClass("ds-reply-active")) h.el.fadeOut(200, function() {
                        ...
                        h ? h.actionsBar.removeClass("ds-reply-active") : (h = new at.Replybox(e), h.render(!0).el.addClass("ds-inline-replybox").detach()), h.el.find("[name=parent_id]").val(i.attr("data-post-id")), h.el.show().appendTo(s.closest(".ds-ctx-body, .ds-comment-body")).find("textarea").focus(), h.actionsBar = a.addClass("ds-reply-active"), t.max_depth <= 1 ? h.postList = e.postList.el : (h.postList = i.siblings(".ds-children"), h.postList[0] || (h.postList = $('<ul class="ds-children"></ul>').insertAfter(i)))
                    }
                    return !1
                }
                function d() {
                ...
                function u() {
                    function t() {
                        ...
                        try {
                            if (a.hasClass("ds-comment-context")) st.attr("id", "ds-ctx-bubble").attr("data-post-id", a.attr("data-post-id")).html('<ul id="ds-ctx">' + tt.ctxPost({
                                ...
                                if (!c) throw "no info";
                                st.attr("id", "ds-user-card").attr("data-user-id", c).empty(), ut[c] ? st.html(tt.userInfo(ut[c].data)) : A.get("users/profile", J(l), t)
                            }
                            et.css({
                                bottom: o,
                                left: d
            ...
            var $ = j.jQuery,
                Z = $(e),
                K = $(t);
            e.postMessage && (e.addEventListener ? e.addEventListener("message", y, !1) : e.attachEvent && e.attachEvent("onmessage", y)), j.scrollTo = function(e) {
                var t = e.offset().top;
                ...
                }).appendTo(t.body)), e.html(tt.notify(s))[!s.comments && !s.notifications || "hidden" === nt.data.notify_position || $(".ds-dialog")[0] ? "hide" : "show"]()
            }, dt.on("reset", j.resetNotify), at.Replybox = function(e) {
                this.embedThread = e
            }, at.Replybox.prototype = {
                render: function(e) {
                    function s(e) {
                        e.data("submitting", !0), e.find(".ds-post-button").addClass("ds-waiting").html(D.posting)[0].disabled = !0
                    }
                    function a(e) {
                        e.data("submitting", !1), e.find(".ds-post-button").removeClass("ds-waiting").html(D.post)[0].disabled = !1
                    }
                    var i = this,
                        n = i.embedThread,
                        o = n.options,
                    ...
                    for (var f in ot.data.repostOptions) ot.data.repostOptions[f] && (h.repostArray.push(f), h.checked = 1);
                    var v = i.el = $(tt.replybox(h)).click(c),
                        ...
                        w = v.find(".ds-add-emote").click(function(e) {
                            ...
                            return w.toggleClass("ds-expanded").hasClass("ds-expanded") ? (s || (s = j.smiliesTooltip = new at.SmiliesTooltip, s.render(), j.require("smilies", function() {
                                s.reset("微博-默认")
                    ...
                    var q = function(e) {
                            s(g), A.post("posts/create", $.extend(j.toJSON(g), e), function(e) {
                                var t = ct[e.response.post_id] = new G(e.response),
                                    s = z(i.postList, t, o);
                                if ("asc" == o.order == ("top" == o.formPosition) && j.scrollTo(s), n.data.comments++, n.updateCounter("duoshuo"), k.val("").trigger("keyup"), a(g), v.hasClass("ds-inline-replybox") && (v.detach(), i.actionsBar.removeClass("ds-reply-active")), m) try {
                    ...
                    if (_.click(function() {
                        return $(this).toggleClass("ds-service-icon-grey").toggleClass("ds-service-icon"), y.value = $.map(_, C).join(","), y.checked = "" != y.value, !1
                    }), $(y).change(function() {
                        var e = this.checked;
                        _[e ? "removeClass" : "addClass"]("ds-service-icon-grey")[e ? "addClass" : "removeClass"]("ds-service-icon"), this.value = $.map(_, C).join(",")
                    }), !e && m) {
                ...
                init: function(e, t) {
                    (this.el = $("#ds-wrapper"))[0] || (this.el = f($('<div id="ds-wrapper"></div>'))), this.options = $.extend({
                        width: 600
                ...
                open: function() {
                    ...
                    var a = this;
                    return a.el.hide().appendTo(t.body).fadeIn(200), O.ie6 && a.el.css("top", Z.scrollTop() + 100), a.el.show().find(".ds-dialog").delegate("a.ds-dialog-close", "click", function() {
                        return a.close(), !1
                ...
                render: function() {
                    function a(a) {
                        ...
                        if (A.post("threads/vote", {
                            ...
                            vote: p ? 0 : 1
                        }, r), l.toggleClass("ds-thread-liked"), l.find(".ds-thread-like-text").text(p ? "喜欢" : "已喜欢"), p) return i.tooltip && c(a), !1;
                        if (i.tooltip === s) {
                        ...
                        var f = {};
                        return f.left = 0, f.top = d.position().top + d.outerHeight() - 4 + "px", i.tooltip.appendTo(i.embedThread.innerEl).css(f), $(t.body).click(c), !1
                    }
                    var i = this,
                ...
                render: function() {
                    ...
                    function t() {
                        return n.find("a.ds-current").removeClass("ds-current"), a.params.order = s.options.order = this.className.replace("ds-order-", ""), a.params.page = 1, a.refetch(), $(this).addClass("ds-current"), !1
                    }
                ...
                function t() {
                    return i.params.page = parseInt(this.innerHTML), i.refetch(), a.find(".ds-current").removeClass("ds-current"), $(this).addClass("ds-current"), !1
                }
                e = e || {};
                var s = this,
                ...
                render: function() {
                    function e() {
                        var e = s.replybox,
                            ...
                            r = i.value;
                        if (t.selection) {
                            i.value = r.substring(0, a.data("ds-range-start")) + this.title + r.substring(a.data("ds-range-end"), r.length), i.value = i.value.replace(D.leave_a_message, ""), i.focus();
                            var n = t.selection.createRange();
                ...
                reset: function(e) {
                    function t(t, s) {
                        ...
                        "WordPress" === e && (t = " " + t + " "), a += '<li><img src="' + i + '" title="' + k(t) + '" /></li>'
                    }
            ...
            et.mouseenter(M).mouseleave(R), at.PostList = function(e) {
                e && (e.params && (this.params = e.params), e.embedThread && (this.embedThread = e.embedThread)), this.el = $('<ul class="ds-comments"></ul>')
                ...
                refetch: function() {
                    function e(e) {
                        ct.set(e.parentPosts || e.relatedPosts), ut.set(e.users), s.reset(e.response), s.embedThread.paginator.reset(e.cursor), s.el.fadeTo(200, 1), j.scrollTo(s.el), a.remove()
                    }
                    var s = this,
                ...
                render: function() {
                    ...
                    s ? e.data("url", w(s)) : e.data("container-url", h.href), t && 400 >= t && e.addClass("ds-narrow").data("max-depth", 1)
                },
                ...
                onload: function(t) {
                    ...
                    a.model = new Y(a.data = t.thread), ct.set(t.parentPosts || t.relatedPosts), ut.set(t.users), a.el.find("#ds-waiting").remove(), o.like_thread_enabled && (a.meta = new at.Meta(a), d.append(a.meta.render().el)), o.hot_posts && t.hotPosts && t.hotPosts.length && (a.hotPosts = new at.HotPosts($('<div class="ds-rounded"></div>'), {
                        max_depth: 1,
                    ...
                    l.postList = a.postList.el, r() ? a.loginButtons = $(tt.loginButtons()).delegate("a.ds-more-services", "click", function() {
                        return a.loginButtons.find(".ds-additional-services").toggle(), !1
                    }).delegate("a.ds-service-link", "click", u) : a.toolbar = $(tt.toolbar()).delegate(".ds-account-control", "mouseenter", function() {
                    ...
                    "top" == o.formPosition && $.fn.append.apply(d, c), d.append(a.postListHead.render().el, a.postList.el, a.paginator.el), "bottom" == o.formPosition && $.fn.append.apply(d, c), d.append(tt.poweredBy(o.poweredby_text)), a.updateCounter(), t.alerts && $.each(t.alerts, function(e, t) {
                        $('<div class="ds-alert">' + t + "</div>").insertBefore(a.toolbar || loginButtons)
                    }), o.message && textarea.val(o.message).focus(), dt.on("reset", function() {
                        var e = dt.data.comments || 0;
                        d.find("a.ds-unread-comments-count").html(e).attr("title", e ? "你有" + e + "条新回复" : "你没有新回复").css("display", e ? "inline" : "none")
                    }), o.mzadx_id && (j.require("mzadxN", function() {}), $('<div id="MZADX_' + o.mzadx_id + '" style="margin:0 auto;"></div>').appendTo(d), __mz_rpq = e.__mz_rpq || [], __mz_rpq.push({
                        l: [o.mzadx_id],
                        r: "1",
                        _srv: "MZADX",
                        _callback: function() {}
                ...
                onload: function(e) {
                    e.options = $.extend(this.options, e.options), V.prototype.onload.call(this, e), B.call(this.el.find("ul"), this.thread, this.options)
                }
                ...
                render: function() {
                    var e = this.el;
                    e.attr("id", "ds-login").html(tt.loginWidget(["weibo", "qq", "renren", "kaixin", "douban", "netease", "sohu"])), e.find("a").click(u), e.find("a.ds-logout").attr("href", X.logoutUrl())
                }
                ...
                render: function() {
                    ...
                    this.el.attr("id", "ds-share"), this.el.children().attr("id", "ds-reset"), this.el.find(".ds-share-aside-inner").html(tt.shareWidget(e)), this.el.find(".ds-share-icons-more").html(tt.shareWidget(e)), this.el.find(".ds-share-icons-more").hide(), this.el.hasClass("flat") && this.el.find("a").each(function() {
                        $(this).addClass("flat")
            ...
            j.initSelector = function(e, t) {
                ...
                !C() || !$.isReady && P || $(e).each(function(e, s) {
                    ...
                    if (!i.data("initialized")) {
                        ...
                        if (it.push(r), "ThreadCount" === t.type) {
                            ...
                            i.attr("data-channel-key") && (n = i.attr("data-channel-key") + ":" + n), a.push(n), lt[n] || (lt[n] = new Y({})), lt[n].on("reset", function() {
                                r.onload(this)
                            })
                        } else if (r.uri) {
                            var o = {};
                ...
                }, 2e4), c.ondomready && c.ondomready(), j.initView(), !pt && c.short_name && A.get("analytics/ping", J({}), H)
            })
        })
    }
}(window, document);